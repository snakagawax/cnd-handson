...
data:
  Corefile: |
    .:53 {
        ...
        # 下記追加
        hosts {
           IPアドレス app.argocd.vm25.handson.cloudnativedays.jp
           IPアドレス app-preview.argocd.vm25.handson.cloudnativedays.jp
           IPアドレス prometheus.vm25.handson.cloudnativedays.jp
           fallthrough
        }
        # ここまで
 ...
 * app.argocd.vm25.handson.cloudnativedays.jp
 * app-preview.argocd.vm25.handson.cloudnativedays.jp
