...
data:
  Corefile: |
    .:53 {
        ...
        # 下記追加
        hosts {
           IPアドレス app.argocd.vm07.handson.cloudnativedays.jp
           IPアドレス app-preview.argocd.vm07.handson.cloudnativedays.jp
           IPアドレス prometheus.vm07.handson.cloudnativedays.jp
           fallthrough
        }
        # ここまで
